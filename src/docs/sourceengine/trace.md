...
## **hull(mask, start, end, mins, maxs, trace_type, should_hit_entity_callback)**: [trace_t](../types/trace_t/)
Type | Name | Description
------------ | ------------- | ------------
number | mask | Trace mask
[vec3_t](../../types/vec3_t/) | start | Start trace position
[vec3_t](../../types/vec3_t/) | end | End trace position
[vec3_t](../../types/vec3_t/) | mins | Trace mins
[vec3_t](../../types/vec3_t/) | maxs | Trace maxs
...
function should_hit_ent_fn(entity_index, contents_mask)
  if entity_index == engine.get_local_player() then return false end

  -- client.notify("should_hit_ent")
